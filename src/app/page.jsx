    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-0">
        ...
        <p className="mx-auto mt-4 max-w-5xl text-center text-xl font-bold text-yellow-200">
          ...
          from your phone or even with your voice. Even when you’re not at home,
          you’ll still have full control, helping you save on electricity bills.
          The moment you open the door and step inside, the lights will turn on
